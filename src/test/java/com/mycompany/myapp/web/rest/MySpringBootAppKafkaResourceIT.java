...
class MySpringBootAppKafkaResourceIT {
    ...
    void setup() {
        ...
        MySpringBootAppKafkaResource kafkaResource = new MySpringBootAppKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/my-spring-boot-app-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/my-spring-boot-app-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
