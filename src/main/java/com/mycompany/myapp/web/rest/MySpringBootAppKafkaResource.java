...
@RestController
@RequestMapping("/api/my-spring-boot-app-kafka")
public class MySpringBootAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MySpringBootAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MySpringBootAppKafkaResource(KafkaProperties kafkaProperties) {
